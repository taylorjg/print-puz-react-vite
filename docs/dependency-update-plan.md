...
| 7 — Framework majors | In progress | React **19.2.7** + `@testing-library/react` 16 + `eslint-plugin-react-hooks` 7; **react-router-dom 7.18** (removed v6 `future` flags in tests); MUI/Cypress still pending |
